...
//Здесь получаю фильмы с помощью fetch
...
// Когда  открываю модалку не должно  скролит
// страница не прокручиваться.
document.body.classList.add("stop-scrolling")
  ...
  <div class="modal__card">
    <img class="modal__movie-backdrop" src="${respData.posterUrl}" alt="">
      ...
      <button type="button" class="modal__button-buy">Купить</button>
      </div>
  </div>
`;
...
// кнопка и модалка закрыть
function closeModal() {
  modalEl.classList.remove('modal--show');
  document.body.classList.remove("stop-scrolling")
}

// // Глобальный обработчик все окно функция закрытия при клике windows
